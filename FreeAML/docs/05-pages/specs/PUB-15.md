# PUB-15 — Identity verification

- **Name:** Identity verification
- **URL (freeze):** `/identity-verification`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («IDV product intent») into a verification start. Keywords: identity verification australia.
...
- [ ] Unique title/H1 for `identity verification australia`
