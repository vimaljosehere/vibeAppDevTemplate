...
- **Name:** Accountants
- **URL (freeze):** `/accountants`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Industry: accountants») into a verification start. Keywords: accountant aml.
...
- [ ] Unique title/H1 for `accountant aml`
