...
- **Name:** KYC check
- **URL (freeze):** `/kyc-check`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («KYC-specific demand») into a verification start. Keywords: kyc check.
