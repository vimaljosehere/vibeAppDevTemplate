# PUB-20 — AUSTRAC compliance

- **Name:** AUSTRAC compliance
- **URL (freeze):** `/austrac-compliance`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Regulator-framed compliance») into a verification start. Keywords: austrac compliance.
...
## Unique intent / CTA
- Intent: Regulator-framed compliance
...
- [ ] Unique title/H1 for `austrac compliance`
