# PUB-13 — Free KYC check

- **Name:** Free KYC check
- **URL (freeze):** `/free-kyc-check`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Free/trial intent KYC») into a verification start. Keywords: free kyc check.
...
- [ ] Unique title/H1 for `free kyc check`
