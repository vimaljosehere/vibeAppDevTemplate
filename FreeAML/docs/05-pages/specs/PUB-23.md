...
- **Name:** Tranche 2
- **URL (freeze):** `/tranche-2`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Tranche 2 awareness») into a verification start. Keywords: tranche 2 austrac.
...
- [ ] Unique title/H1 for `tranche 2 austrac`
