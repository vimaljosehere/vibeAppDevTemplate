...
- **Name:** Jewellers
- **URL (freeze):** `/jewellers`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Industry: jewellers») into a verification start. Keywords: jeweller aml.
...
- [ ] Unique title/H1 for `jeweller aml`
