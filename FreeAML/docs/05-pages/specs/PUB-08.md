...
- **Name:** AML check
- **URL (freeze):** `/aml-check`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («General AML check demand») into a verification start. Keywords: aml check australia.
...
## Unique intent / CTA
- Intent: General AML check demand
...
- [ ] Unique title/H1 for `aml check australia`
