# PUB-14 — Free identity verification

- **Name:** Free identity verification
- **URL (freeze):** `/free-identity-verification`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Free IDV intent») into a verification start. Keywords: free identity verification.
...
- [ ] Unique title/H1 for `free identity verification`
