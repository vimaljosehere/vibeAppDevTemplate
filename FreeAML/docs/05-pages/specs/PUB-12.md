# PUB-12 — Free AML check

- **Name:** Free AML check
- **URL (freeze):** `/free-aml-check`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Free/trial intent AML») into a verification start. Keywords: free aml check.
...
- [ ] Unique title/H1 for `free aml check`
