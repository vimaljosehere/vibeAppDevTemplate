...
- **Name:** Vs EasyAML
- **URL (freeze):** `/vs/easyaml`
- **Audience:** public
- **Purpose:** Competitive comparison vs EasyAML; convert to FreeAML (no remint competitor KYCs — R-009).
...
## Analytics
- `vs_page_view` competitor=easyaml
- No OTPs / ID docs / Personr payloads / raw capability URLs.

## Acceptance criteria
- [ ] Frozen `/vs/easyaml`
- [ ] CTA to start check
- [ ] Does not promise reminting EasyAML history
