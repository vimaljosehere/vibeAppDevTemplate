# PUB-16 — Entity verification

- **Name:** Entity verification
- **URL (freeze):** `/entity-verification`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («KYB/entity intent») into a verification start. Keywords: entity verification, ABN.
...
- [ ] Unique title/H1 for `entity verification, ABN`
