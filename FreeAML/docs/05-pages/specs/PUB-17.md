# PUB-17 — UBO verification

- **Name:** UBO verification
- **URL (freeze):** `/ubo-verification`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Beneficial ownership intent») into a verification start. Keywords: ubo verification.
...
## Unique intent / CTA
- Intent: Beneficial ownership intent
...
- [ ] Unique title/H1 for `ubo verification`
