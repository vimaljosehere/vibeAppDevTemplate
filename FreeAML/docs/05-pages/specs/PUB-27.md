...
- **URL (freeze):** `/lawyers`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Industry: lawyers») into a verification start. Keywords: lawyer aml kyc.
...
- [ ] Unique title/H1 for `lawyer aml kyc`
