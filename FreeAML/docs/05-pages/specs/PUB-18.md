# PUB-18 — Customer due diligence

- **Name:** Customer due diligence
- **URL (freeze):** `/customer-due-diligence`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («CDD education + convert») into a verification start. Keywords: customer due diligence.
...
- [ ] Unique title/H1 for `customer due diligence`
