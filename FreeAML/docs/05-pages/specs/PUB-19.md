...
- **Name:** CDD report
- **URL (freeze):** `/cdd-report`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Report artifact intent») into a verification start. Keywords: cdd report.
...
- [ ] Unique title/H1 for `cdd report`
