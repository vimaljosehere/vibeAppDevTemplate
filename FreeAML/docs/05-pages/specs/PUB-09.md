# PUB-09 — AML check cost

- **Name:** AML check cost
- **URL (freeze):** `/aml-check-cost`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Price-intent AML check») into a verification start. Keywords: aml check cost.
...
- [ ] Unique title/H1 for `aml check cost`
