...
- **Name:** Real estate
- **URL (freeze):** `/real-estate`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Industry: real estate») into a verification start. Keywords: real estate aml.
...
- [ ] Unique title/H1 for `real estate aml`
