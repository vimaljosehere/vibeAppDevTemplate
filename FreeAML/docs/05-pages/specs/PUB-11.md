# PUB-11 — KYC check cost

- **Name:** KYC check cost
- **URL (freeze):** `/kyc-check-cost`
- **Audience:** public (SEO)
- **Purpose:** Convert search intent («Price-intent KYC») into a verification start. Keywords: kyc check cost.
...
- [ ] Unique title/H1 for `kyc check cost`
